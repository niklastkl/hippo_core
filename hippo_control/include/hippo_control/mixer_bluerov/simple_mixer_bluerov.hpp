...
namespace hippo_control {
    namespace mixer_bluerov {
        ...
        public:
            ...
            void
            InitializeMixerMatrix(double alpha_f, double alpha_r, double l_hf, double l_hr, double l_vx, double l_vy);
        ...
        private:
            ...
            bool IsInDeadZone(const double &thruster_value, const double &deadzone_min, const double &deadzone_max);


            template<int size_output>
            void UpdateScaling(const Eigen::Matrix<double, size_output, 1> &thrusters0, double deadzone_min,
                               double deadzone_max, const Eigen::Matrix<double, size_output, 1> &nullspace,
                               double &scaling);

            template<int size_output>
            bool
            IsSaturated(const Eigen::Matrix<double, size_output, 1> &thrusters, double limit_min, double limit_max);

            template<int size_output>
            Eigen::Matrix<double, size_output, 1>
            ChooseBetter(const std::array<Eigen::Matrix<double, size_output, 1>, 2> &thrusters_scaled,
                         const Eigen::Matrix<double, size_output, 1> &last_thrusters);


            template<int size_input, int size_output>
            Eigen::Matrix<double, size_output, 1>
            ResolveDeadzone(const Eigen::Matrix<double, size_output, size_input> &M_inv,
